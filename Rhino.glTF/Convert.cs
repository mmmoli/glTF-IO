...
{
    public static byte[] ToGlb(glTFExportOptions options, IEnumerable<RhinoObject> objects, Action<List<ObjectExportData>> transform)
    {
        ...
        RhinoDocGltfConverter converter = new(options, true, doc, objects, workflow, transform);
